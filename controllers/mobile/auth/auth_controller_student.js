...
module.exports.register = async (req, res, next) => {
    try {
        ...
        const existingPhoneNumber = await Users.findOne({ where: { phoneNumber: phoneNumber } });
        ...
        // Create the user
        await Users.create({ name , password: hashpassword , email , phoneNumber , classId,walletId:wallet_id,imagePath:defaultImagePath });
